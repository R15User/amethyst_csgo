#pragma once
#include <cstdint>
#include "../source-sdk/math/vector3d.h"
#include "../source-sdk/math/vector2d.h"
#include "../source-sdk/math/view_matrix.h"
#include "../source-sdk/classes/net_channel.h"
...
public:
	...
	void get_view_angles(vec3_t& angles) {
		return memory::call_virtual<void(__thiscall*)(void*, vec3_t&)>(this, 18)(this, angles);
	}
